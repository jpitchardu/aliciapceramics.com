...
export function CartClient() {
  ...
  return (
    <>
      ...
      {/* title */}
      <div style={{ padding: "0 56px 0", textAlign: "center" }}>
        <span
          style={{
            fontFamily: "var(--serif)",
            fontSize: 28,
        ...
        <div style={{ paddingTop: 18, borderTop: "1px solid var(--rule-strong)" }}>
          <div
            style={{
              paddingBottom: 14,
              display: "grid",
              gridTemplateColumns: "140px 1fr auto 24px",
              gap: 28,
            }}
          >
          ...
          {items.map((item, i) => (
            ...
            >
              ...
              <div style={{ paddingTop: 4 }}>
                <CeramicLabel color="var(--ink-faint)">
                  no. {item.piece.n} · creating spring
                </CeramicLabel>
                <div
                  style={{
                    marginTop: 10,
                ...
                >
                  {item.piece.glaze && <li>glazed in {item.piece.glaze}</li>}
                  {item.piece.dim && <li>{item.piece.dim}</li>}
                </ul>
              </div>
